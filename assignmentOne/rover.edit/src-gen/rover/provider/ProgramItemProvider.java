	...
	protected void addBlockPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Program_block_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Program_block_feature",
								"_UI_Program_type"),
						RoverPackage.Literals.PROGRAM__BLOCK, true, false, true, null, null, null));
	}
