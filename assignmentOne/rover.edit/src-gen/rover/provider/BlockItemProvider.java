...
public class BlockItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTansitionPropertyDescriptor(object);
	...
	protected void addCommandPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Block_command_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Block_command_feature", "_UI_Block_type"),
						RoverPackage.Literals.BLOCK__COMMAND, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Tansition feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTansitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Block_tansition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Block_tansition_feature",
								"_UI_Block_type"),
						RoverPackage.Literals.BLOCK__TANSITION, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RoverPackage.Literals.BLOCK__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RoverPackage.Literals.BLOCK__TANSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(RoverPackage.Literals.BLOCK__COMMAND, RoverFactory.eINSTANCE.createCommand()));

		newChildDescriptors.add(
				createChildParameter(RoverPackage.Literals.BLOCK__TANSITION, RoverFactory.eINSTANCE.createTansition()));
	}
