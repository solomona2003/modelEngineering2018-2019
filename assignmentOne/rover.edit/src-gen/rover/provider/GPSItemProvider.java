 ...
 * @generated
 */
public class GPSItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCurrentPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GPS_currentPosition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GPS_currentPosition_feature",
								"_UI_GPS_type"),
						RoverPackage.Literals.GPS__CURRENT_POSITION, true, false, false,
	...
	public String getText(Object object) {
		GPS gps = (GPS) object;
		return getString("_UI_GPS_type") + " " + gps.getCurrentPosition();
	}
