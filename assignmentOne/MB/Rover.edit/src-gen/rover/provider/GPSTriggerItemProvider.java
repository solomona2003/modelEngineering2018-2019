...
/**
 * This is the item provider adapter for a {@link rover.GPSTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GPSTriggerItemProvider extends TriggeredTransitionItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_GPSTrigger_gps_feature",
								"_UI_GPSTrigger_type"),
						RoverPackage.Literals.GPS_TRIGGER__GPS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_GPSTrigger_position_feature",
								"_UI_GPSTrigger_type"),
						RoverPackage.Literals.GPS_TRIGGER__POSITION, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		Operator labelValue = ((GPSTrigger) object).getOperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_GPSTrigger_type")
