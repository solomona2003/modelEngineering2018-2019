...
/**
 * This is the item provider adapter for a {@link rover.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RoverPackage.Literals.SYSTEM__ROVER);
			childrenFeatures.add(RoverPackage.Literals.SYSTEM__PROGRAM);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(rover.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(RoverPackage.Literals.SYSTEM__ROVER, RoverFactory.eINSTANCE.createRover()));

		newChildDescriptors.add(
				createChildParameter(RoverPackage.Literals.SYSTEM__PROGRAM, RoverFactory.eINSTANCE.createProgram()));
	}
