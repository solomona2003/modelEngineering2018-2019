 ...
 *   <li>{@link rover.impl.RoverImpl#getProgram <em>Program</em>}</li>
...
public class RoverImpl extends MinimalEObjectImpl.Container implements Rover {
	...
	public NotificationChain basicSetProgram(Program newProgram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RoverPackage.ROVER__PROGRAM,
		...
		if (newProgram != program) {
			...
			if (program != null)
				msgs = ((InternalEObject) program).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RoverPackage.ROVER__PROGRAM, null, msgs);
			if (newProgram != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RoverPackage.ROVER__PROGRAM, newProgram, newProgram));
	}
