...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
		...
		if (block != null && block.eIsProxy()) {
			...
			if (block != oldBlock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RoverPackage.PROGRAM__BLOCK, oldBlock,
							block));
			}
		}
		return block;
	...
	public void setBlock(Block newBlock) {
		...
		block = newBlock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoverPackage.PROGRAM__BLOCK, oldBlock, block));
	}
